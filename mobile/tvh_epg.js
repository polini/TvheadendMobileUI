	...
	for (var i in channels) {
		for (var j in channels[i]) {
			...
			if (e.ch_icon != undefined && e.ch_icon != "") 
				html += '<img id="i_'+e.chid+'" height="'+lh+'px" onclick="showChannel('+e.chid+');" class="channel'+(window.blackLogo?' black':'')+'" src="'+e.ch_icon+'" alt="'+e.name+'" title="'+e.name+'" style="left:0px;top:'+y+'px;" />';
			else
